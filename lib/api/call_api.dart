...
class CallApi {
  static Future<dynamic> getRestauranData() async {
    ...
    final url = Uri.parse('https://webservice.recruit.co.jp/hotpepper/gourmet/v1/?key=${Env.key}&format=json&lat=${locationData.latitude}&lng=${locationData.longitude}&range=5');
